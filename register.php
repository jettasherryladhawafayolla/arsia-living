...
<head>
    ...
    <title> Register | arsialiving</title>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="login_part_text text-center">
                        <div class="login_part_text_iner">
                            ...
                            <p>Masuk sekarang dan nikmati pengalaman berbelanja
                                furniture terbaik dengan penawaran nemarik serta
                    ...
                    <div class="login_part_form">
                        <div class="login_part_form_iner">
                            ...
                            <form class="row contact_form" action="#" method="post">
                                ...
                                <div class="col-md-12 form-group p_star">
                                    <input type="password" class="from-control" id="confirm_password" name="password2" placeholder="Konfirmasi Password">
                                </div>
