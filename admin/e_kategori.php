                        ...
                        <div class="card-body">
                            <form class="row g-3 mt-2" method="post">
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" id="nm_kategori" name="nm_kategori" placeholder="masukkan nama kategori produk" value="<?php echo htmlspecialchars($data['nm_kategori']); ?>">
                                </div>
