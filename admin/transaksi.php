...
<body>
    ...
    <main id="main" class="main">
        ...
        if (!empty($kategori_filter)) {
            // Jika kategori dipilih, filter berdasarkan kategori yang berkaitan dengan
        ...
        $sql.= "GRUOP BY j.id_jual ORDER BY j.tgl_jual ASC"; // Mengelompokan 
                ...
                <div class="card">
                    <div class="card-body">
                       <div class="filter-bar mt-3">
                            <from class="filter-form d.flex align-items-center" method="GET" action="">
                            ...
                            <tbody>
                                ...
                                if ($result->num_rows > 0) {
                                    while($row = $result->fetch()) {
                                        ...
                                        echo "<td>" .date("d-n-Y H:i:s", strtotime($row["tgl_jual"])) . "</td>";
