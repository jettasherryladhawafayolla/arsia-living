...
<head>
    ...
    <title>Laporan - Arsialiving Admin</title>
...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            $sqlTransaksi = "SELECT COUNT(*) as total FROM tb_kategori";
            $resultTransaksi = $koneksi->query($sqlTransaksi);
            $dataTranksaksi = $resultTranksaksi->fetch_assoc();
            $adaTranksaksi = ($dataTranksaksi['total'] > 0);
            ...
            <section class="section">
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <select id="laporanSelect" class="form-select" onchange="u"
                            <option value="" selected disabled>Pilih Laporan</option>
                            <option value="produk">Produk</option>
                            <option value="tranksaksi">Transaksi</option>
                        </select>
                        </div>
                        ...
                        <script>
                            function updateTipeLaporan() {
                                ...
                                } else if (LaporanSelect === "tranksaksi") {
                                    let optionAll = document.createElement("option");
                                    optionAll.value = "all";
                                    optionAll.textContent = "All";
                                    tipeLaporanSelect.appendChild(optionAll);
                        ...
                        <div class="filter-bar mt-3">
                            <from class="filter-form d.flex align-items-center" method="GET"
                            action="">
                            ...
                            <button type="sumbit" class="btn btn-primary ms-2">filter<button>
                        </form>
                        </div><!-- End Filter Bar -->
